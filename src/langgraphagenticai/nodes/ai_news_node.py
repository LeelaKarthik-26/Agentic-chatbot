...
class AINewsNode:
    ...
    def fetch_news(self, state: dict) -> dict:
        ...
        Args:
            state (dict): The state dictionary containing 'frequency' key.
    ...
    def summarize_news(self, state: dict) -> dict:
        ...
        Args:
            state (dict): The state dictionary containing 'new_data' key.

        Returns:
            dict: The updated with 'summary' key containing the summarized news.
        """
        
        news_items = self.state['new_data']
